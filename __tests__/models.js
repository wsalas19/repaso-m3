...
describe("Model", function () {
	...
	xdescribe("addFamily` and `listFamilies`", function () {
	...
	xdescribe("`showQuotes` y `addQuote`", function () {
		it("Inicialmente devuelve un arreglo vacío", function () {
			Model.addFamily("Simpsons");
			Model.addCharacter("Homero", 36, "Simpsons");
		...
		it("Agrega una frase al personaje", function () {
			...
			expect(Model.showQuotes("Homero")[0].text).toEqual(
			...
			expect(Model.showQuotes("Homero")[1].text).toEqual(
