...
describe('Routes', function() {
  ...
  describe('/families', function() {
    ...
    xit('GET responde con un array con los nombres de todas las familias agregadas', function() {
    ...
    xit('POST agregar una nueva familia y devuelve el nombre de la familia agregada', function() {
      return supertest
        .post('/families')
  ...
  describe('/characters', function() {
    ...
    xit('POST agrega un nuevo personaje y lo devuelve', function() {
      model.addFamily('Simpsons');
      return supertest
        .post('/characters')
  ...
  describe('/quotes', function() {
    xit('GET responde con un array vacío si el personaje no existe', function() {
      return supertest
        .get('/quotes')
        .expect(200)
        .expect('Content-Type', /json/)
    ...
    xit('GET responde con todas las frases del personaje indicado pasado por body', function() {
      model.addFamily('Simpsons');
      model.addCharacter('Homero', 36, "Simpsons");
    ...
    xit('POST agrega una nueva frase al personaje indicado y devuelve el mensaje indicado', function() {
      model.addFamily('Simpsons');
      model.addCharacter('Homero', 36, "Simpsons");
      model.addQuote("Homero", {text: "Marge, no voy a mentirte"});
      return supertest
