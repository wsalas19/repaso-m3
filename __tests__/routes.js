	...
	xdescribe("/characters", function () {
		...
		it("GET responde con un array de todos los personajes", function () {
			...
			return supertest
				...
				.expect(function (res) {
					expect(res.body).toEqual([
						{ name: "Homero", age: 36, quotes: [], familyId: 1 },
	...
	describe("/quotes", function () {
		...
		it("GET responde con todas las frases del personaje indicado pasado por body", function () {
			...
			return supertest
				...
				.expect(function (res) {
					expect(res.body).toEqual([
						{ season: false, text: "Marge, no voy a mentirte" },
						{ season: false, text: "No existe la tecla cualquiera" },
			...
			return supertest
				...
				.expect(function (res) {
					...
					expect(model.showQuotes("Homero")).toEqual([
						{ season: false, text: "Marge, no voy a mentirte" },
						{ season: false, text: "Na na na na na na na na na na Henry" },
					]);
				});
		});
	});
